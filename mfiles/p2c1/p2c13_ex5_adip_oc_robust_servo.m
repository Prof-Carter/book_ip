% 例 1.5
% アーム型倒立振子
% 多目的ロバスト制御（四つの端点に対する非線形シミュレーション）
...
for i = 1:2^nop
    ...
    figure(1); plot(real(poles),imag(poles),symb,'LineWidth',2,'MarkerSize',8)
    hold on
end

figure(1)
xlim([-50 0])
set(gca,'xtick',-50:10:0)
ylim(20*[-1 1])
set(gca,'ytick',-20:10:20)
set(gca,'FontName','arial','FontSize',14)
xlabel('Real Part','FontName','arial','FontSize',16)
ylabel('Imaginary Part','FontName','arial','FontSize',16)
legend('$\rho = [\underline{\rho}{}_{1}\ \ \underline{\rho}{}_{2}]^{\top}$',...
...
plot(-alpha*[1 1],20*[-1 1],'k')
plot( -beta*[1 1],20*[-1 1],'k')
hold off
